...
const theme = createTheme({
  palette: {
    type: 'dark',
    primary: { main: '#B5CCFA', light: '#CDF7D2', dark: '#004708' },
    background: {
      default: '#232743',
      paper: '#232743',
      light: '#313759',
    ...
    MuiCssBaseline: {
      '@global': {
        ':root': {
          ...
          '--onboard-connect-header-color': '#262626',
          '--onboard-modal-color': '#262626',
          ...
          '--onboard-wallet-button-border-color': '#3F4D68',
          '--onboard-wallet-button-background': '#3F4D68',
          ...
          '--onboard-connect-sidebar-background': '#3F4D68',
          '--onboard-connect-sidebar-color': '#262626',
        },
      },
    },
    MuiInputBase: {
